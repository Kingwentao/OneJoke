...
class MainActivity : AppCompatActivity(),EasyPermissions.PermissionCallbacks {
    ...
    private fun requestSomePermission() {
        ...
        val per = arrayListOf<String>(Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.READ_EXTERNAL_STORAGE)
    ...
    private fun testCreateDataBase() {
        ...
        val daoSupport = DaoSupportFactory.getDao(this.javaClass)
    }
